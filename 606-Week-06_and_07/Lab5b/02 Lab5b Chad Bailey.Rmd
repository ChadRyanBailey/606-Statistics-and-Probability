---
title: 'Data606 Lab 5b - Foundations for statistical inference - Confidence intervals'
...
## 1.1 The sample distribution was unimodal, right skewed, with a mean of 1452,
##     and a median of 1347.
## 1.2 The "typical" size would be 1347.
## 1.3 I interpreted "typical" to be a measure that accurately summarizes a
##     a majority of the data. Median does that better in a skewed data set.
...
## mean was 92% (46/50). This was close, but not exactly equal, to 95%. This
## variation is acceptable as 95% confidence does not mean it is impossible for
## for more, or less, events to be within the interval, only that is improbable.
