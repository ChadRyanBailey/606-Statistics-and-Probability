---
title: 'Data606 Lab 5a - Foundations for statistical inference - Sampling distributions'
...
```{r exercise1}
## Student reponse to exercise 1

## The distribution of the variable 'area' is unimodal, has a mean of 1,500,
## is right skewed, and has some extreme outliers on the right.
...
## The distribution of the variable 'area, sample 1' is unimodal, has a mean 
## of 1609, and has a right skew.
...
## The second sample has a mean that is lower by 45.98 square feet.
  
## If two more samples were taken, one size of 100 and the other size 1,000,
## it is more probable, though not assured, that the larger sample (size 1,000)
## would more accurately estimate the population mean.
...
## 4.a  There are 5,000 elements in 'sample_means50'
## 4.b  The distribution of 'sample_means50' is unimodal, nearly symmetrical,
##      with a mean of 1,500.
## 4.c  If we instead took 50,000 samples of size 50, it would be expected
##      that the center remain very near 1,500 though the distribution would 
##      probably smooth to further approach symmetry.
...
5.  To make sure you understand what you've done in this loop, try running a 
    ...
    - Print the output to your screen (type `sample_means_small` into the 
...
## 5.b There are 100 elements in 'sample_means_small'
## 5.c Each element in 'sample_means_small' represents the mean of one of
##     the 100 samples taken from the varialbe 'area'.
...
## The size of the inidividual samples doesn't seems to have much effect on the
## mean of the sample means. This is seen in that with all three sample sizes,
## the mean of the means is at or very near 1,500.

## The size of the indiviudal samples seems to have a greater impact on the
## spread of the sample means. There appears to be that with larger samples the
## spread of the sample means decreases.
...
## Student response to 'On your own 1'
  ...
  ## Using the random sample of size 50, the best point estimate of teh population
  ## mean is $181,541.10
...
## Student response to 'On your own 4'
  ...
  ## 4.1  The sampling distribution from 'On your own 3' has a smaller spread.
  ## 4.2  Distributions with smaller spread would be preferred if we are concerned
  ##      with makign estimates that are closer to the true value.
