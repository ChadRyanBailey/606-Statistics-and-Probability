---
title: "Data606 Lab2 - Introduction to Data"
...
##Student response for Exercise 1
  ...
  ## 1.a  20,000 cases (rows) in this dataset
  ## 1.b  9 variables (columns) in this dataset
  ## 1.c  "genHlth"   - categorical - ordinal
  ##      "exerany"   - categorical - nominal
  ##      "hlthplan"  - categroical - nominal
  ##      "smoke100"  - categroical - nominal
  ##      "height"    - numeric - discrete
  ##      "weight"    - numeric - discrete
  ##      "wtdesire"  - numeric - discrete
  ##      "age"       - numeric - discrete
  ##      "gender"    - categroical - nominal
...
##  2.e What proportion of the sample reports being in excellent health?
  ...
  ## 23.285% of the sample report being in excellent health
...
```{r}
### Student response to Excercise 3
##  3.1 The mosaic plot reveals a relationship between smoking habits and gender with males responding at a higher rate to having smoked at least 100 cigarettes.
...
## Student Response to Excercise 5
  ...
  ##  5.2c  The boxplot of BMI and Gender shows a weak relationship between BMI
  ##        and gender, with males tending to having slightly higher BMI values.
...
-   Make a scatterplot of weight versus desired weight. Describe the 
    ...
    ## There is a positive correlation between weight and desired weight.
    ## However, it appears that generally a respondant's desired weight 
    ## is generally lower than their actual weight.
...
-   What type of data is `wdiff`? If an observation `wdiff` is 0, what does 
    ...
    ```{r}
    ##  a.  'wdiff' contains numerical discrete data
    ##  b.  An obervation of 0 would indicate that a persons actual weight and their
    ##      desired weight are the same.
    ##  c.  A positive value of 'wdiff' indicates a respondant desiring to increase
    ##      weight. While a negative value of 'wdiff' indicates a respondant 
    ##      desiring to decrease weight.
...
-   Describe the distribution of `wdiff` in terms of its center, shape, and 
    ...
    ## c. The spread is moderate with SD 24 and IQR 21
    ## d. This tells us people generally would like to decrease their weight slightly
    ```
...
-   Using numerical summaries and a side-by-side box plot, determine if men tend
    ...
    boxplot(wdiff ~ cdc$gender , horizontal = TRUE)
    ...
    ## The numerical analysis and the boxplots show that both men and women
    ## tend to desire a lower weight than their actual weight, with women
    ## tending to have a desired weight farther below their actual weight
    ## as compared to men.
