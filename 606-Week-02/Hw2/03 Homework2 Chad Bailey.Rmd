---
title: "Data606 Homework Chapter 2 - Summarizing Data"
author: 'Completed by Chad Bailey'
output:
  html_document:
    df_print: paged
  pdf_document:
...
```{r echo = FALSE}
## section commented out as it will not print when knitting to HTML
  ##\begin{center}
...
The proportion of the control group that had died by the end of the study was `r control_pctdied`%.  
The proportion of the treatment group that had died by the end of the study was `r treatment_pctdied`%.  
...
> We write *alive* on ____28_____ cards representing patients who were 
alive at the end of the study, and *dead* on ____75____ cards 
...
____at least 23.02_____. If this fraction is low, we conclude that it is unlikely to 
